...
@section('page-title', 'Engines - Admin')
@section('css_before')
    <!-- Page JS Plugins CSS -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Horizontal Primary">
                                            ...
                                            <a href="{{ route('admin.engines.edit', $engine->id) }}"
                                                class="btn btn-sm btn-alt-primary">Edit</a>
                                            <form id="form-{{ $engine->id }}"
                                                action="{{ route('admin.engines.destroy', $engine->id) }}" method="POST">
                                                @method("DELETE")
                                                @csrf
                                                <input type="button" onclick="confirmDelete({{ $engine->id }})"
